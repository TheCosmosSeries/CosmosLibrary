...
public class CosmosScreenBlockEntityListUI<J extends CosmosContainerMenuBlockEntity> extends CosmosScreenBlockEntityUI<J> {
	...
	public CosmosScreenBlockEntityListUI(J containerIn, Inventory playerInventoryIn, Component titleIn) {
	...
	protected void renderScrollElement(GuiGraphics graphics) {
		...
		CosmosUISystem.Setup.setTextureWithColour(graphics.pose(), BASE.GUI_ELEMENT_MISC_LOC, new float[] { 1.0F, 1.0F, 1.0F, 1.0F });
