...
@OnlyIn(Dist.CLIENT)
public class CosmosShieldItemBEWLR extends BlockEntityWithoutLevelRenderer {
	
	private final CosmosShieldModel shieldModel = new CosmosShieldModel();
	
	public CosmosShieldItemBEWLR(ResourceLocation normalIn, ResourceLocation noPatternIn) {
